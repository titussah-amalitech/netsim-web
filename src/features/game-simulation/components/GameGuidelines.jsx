    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
          <div className="group bg-gray-50 flex flex-col justify-center dark:bg-network-surface border-2 border-network-border-light dark:border-network-border rounded-lg p-6 hover:border-network-success dark:hover:border-network-success transition-all hover:shadow-lg">
            <div className="w-14 h-14 mx-auto bg-green-500 rounded-lg flex items-center justify-center mb-4 group-hover:scale-105 transition-transform">
              <Shield className="w-7 h-7 text-white" />
            </div>
            <h3 className="text-lg font-bold mb-3 text-network-text-darker dark:text-network-lighter mx-auto">Monitor Status</h3>
          ...
          <div className="group bg-gray-50 flex flex-col justify-center dark:bg-network-surface border-2 border-network-border-light dark:border-network-border rounded-lg p-6 hover:border-network-warning dark:hover:border-network-warning transition-all hover:shadow-lg">
            <div className="w-14 h-14 mx-auto bg-network-warning rounded-lg flex items-center justify-center mb-4 group-hover:scale-105 transition-transform">
              <AlertTriangle className="w-7 h-7 text-white" />
            </div>
            <h3 className="text-lg font-bold mb-3 text-network-text-darker dark:text-network-lighter mx-auto">Receive Alerts</h3>
            <p className="text-sm text-network-text-dark dark:text-network-text leading-relaxed">
              Get instant notifications when devices encounter issues. Sound and visual alerts keep you informed.
            </p>
          </div>

          <div className="group bg-gray-50 flex flex-col justify-center dark:bg-network-surface border-2 border-network-border-light dark:border-network-border rounded-lg p-6 hover:border-network-accent dark:hover:border-network-accent transition-all hover:shadow-lg">
            <div className="w-14 h-14 mx-auto bg-network-accent rounded-lg flex items-center justify-center mb-4 group-hover:scale-105 transition-transform">
              <Settings className="w-7 h-7 text-white" />
            </div>
            <h3 className="text-lg font-bold mb-3 text-network-text-darker dark:text-network-lighter mx-auto">Fix Issues</h3>
            <p className="text-sm text-network-text-dark dark:text-network-text leading-relaxed">
              Click devices to adjust parameters: ping interval, latency, and failure probability.
            </p>
          </div>

          <div className="group bg-gray-50 flex flex-col justify-center dark:bg-network-surface border-2 border-network-border-light dark:border-network-border rounded-lg p-6 hover:border-network-primary dark:hover:border-network-primary-light transition-all hover:shadow-lg">
            <div className="w-14 h-14 mx-auto bg-network-primary rounded-lg flex items-center justify-center mb-4 group-hover:scale-105 transition-transform">
              <Trophy className="w-7 h-7 text-white" />
            </div>
            <h3 className="text-lg font-bold mb-3 text-network-text-darker dark:text-network-lighter mx-auto">Earn Points</h3>
            <p className="text-sm text-network-text-dark dark:text-network-text leading-relaxed">
