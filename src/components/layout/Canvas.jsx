...
export const Canvas = ({
   ...
   const drawCanvas = useCallback(() => {
      ...
      // Draw connections
      drawConnections(ctx, scenario.devices, theme);
   ...
   }, [scenario.devices, selectedTool, canvasRef, isDarkMode, theme]);
         ...
         <div className="bg-network-surface-light dark:bg-gray-800 rounded-lg p-4">
            <div className="relative">
               <canvas
                  ...
                  className="w-full border border-network-border-light dark:border-network-gray-light rounded-lg cursor-crosshair"
